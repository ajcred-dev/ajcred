...
<header id="header">
    ...
    echo Nav::widget([
        ...
        'items' => [
            ...
            ['label' => 'Busca', 'url' => ['/busca/index']],
            ['label' => 'Convênios', 'url' => ['/convenio/index']],
            ['label' => 'Login de Convênio', 'url' => ['/login-convenio/index']],
            ['label' => 'Importação Lote', 'url' => ['#'],
                'template' => '<a href="{url}" >{label}<i class="fa fa-angle-left pull-right"></i></a>',
                'items' => [
                    ['label' => 'CPF (csv)', 'url' => ['/importacao/cliente']],
                ]
            ],
            ['label' => 'Relatórios',  
                'url' => ['#'],
